...
{
    /// <summary>
    /// Legacy data class from NetworkSkins 1. Used for compatibility.
    ...
    /// </summary>
    public class LegacySegmentData : IDataContainer
    {
        [Flags]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == this.GetType() && Equals((LegacySegmentData)obj);
        }
