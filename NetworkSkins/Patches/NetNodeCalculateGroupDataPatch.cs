...
namespace NetworkSkins.Patches
{
    ...
    public static class NetNodeCalculateGroupDataPatch
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(ILGenerator il, IEnumerable<CodeInstruction> instructions)
        {
            ...
            {
                Debug.LogError("NetNodeCalculateGroupDataPatch: Necessary field for junction not found. Cancelling transpiler!");
                Debug.Log($"{segmentLocalVarLdloc}, {segment2LocalVarLdloc}, {nodeLocalVarLdLoc}");
                return originalCodes;
            }
            ...
            {
                Debug.LogError("NetNodeCalculateGroupDataPatch: Junction render check not inserted. Cancelling transpiler!");
                return originalCodes;
            }
            ...
            {
                Debug.LogError("NetNodeCalculateGroupDataPatch: node5 local var for bend not found. Cancelling transpiler!");
                return originalCodes;
            }
            ...
            {
                Debug.LogError("NetNodeCalculateGroupDataPatch: Bend render check not inserted. Cancelling transpiler!");
                return originalCodes;
            }
